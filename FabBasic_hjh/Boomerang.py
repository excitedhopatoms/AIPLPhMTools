...
def Boomerang(
    ...
    route = gf.routing.get_route(str_out.ports["o2"],taper_in.ports["o2"],radius=RadiusEuler*1.1,cross_section=X_str,)
    ...
    Cringhalf.add_port("Lb1",center=Cringhalf.ports["o22"].center+[0,LengthBridge1+LengthTaper]+(route_bend.ports["o2"].center-route_bend.ports["o1"].center),
    ...
    if IsHeatIn:
        ...
        HeatInHalf = DifferentHeater(PathHeat=path_heat_in,
                                     WidthHeat=WidthHeat,WidthWG=WidthStraight,WidthRoute=WidthRoute,WidthVia=WidthVia,Spacing=Spacing,
