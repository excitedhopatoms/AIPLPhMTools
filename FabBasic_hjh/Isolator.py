...
def SingleRingIsolator1(
    ...
    route_mn = gf.routing.get_bundle(
        ports1=bend_moni.ports["o2"],ports2=str_moni_out.ports["o1"],width=width_single,radius = r_euler_false,layer=oplayer
    )
...
def RingAndIsolator0(
    ...
    route_io = gf.routing.get_bundle(
        ...
        [taper_s2CRin.ports["o1"],taper_s2n_in.ports["o1"], toutring_ad.ports["o1"], toutring_dr.ports["o1"], toutring_th.ports["o1"]],
        width=width_single, layer=oplayer
    )
    for route in route_io:
        sr.add(route.references)
