...
def RaceTrackPulley2HS(
    ...
    secheatout1 = gf.Section(width=RadiusRing, offset=-(DeltaHeat + WidthHeat / 2 + RadiusRing / 2), layer=(30, 10),
                             port_names=("in", "out"))
    ...
    secheatout2 = gf.Section(width=RadiusRing, offset=(DeltaHeat + WidthHeat / 2 + RadiusRing / 2), layer=(30, 10),
                             port_names=("in", "out"))
